...
public class User {
    private static String[] securityQ = {"What city were you born?", "What was the first concert you attended?",
            "In what city did your parent meet?", "What was the make and model of your first car?"};
    ...
    public static MethodReturns securityQuestionPassEdit(String userName, String securityAnswers, String password) {
